 ...
 */
@Config
public class CameraVisionOuttakeDetection {
...
//    public static double cameraZoom = 1.0;  // 1.0 = fully zoomed out (minimum zoom)
    ...
    public static int minContourArea = 15000;
    public static int maxContourArea = 35000;
    public static double minCircularity = 0.2;
//
//    // Timing parameters
...
//    public static double flipUpDurationMs = 1000;  // How long to keep flipper up after detection
    ...
    public static List<ColorBlobLocatorProcessor.Blob> purpleBlobs;
    public static List<ColorBlobLocatorProcessor.Blob> greenBlobs;

    // ==================== HARDWARE COMPONENTS ====================
//    private ElapsedTime cooldownTimer = new ElapsedTime();
//    private ElapsedTime flipTimer = new ElapsedTime();
    private VisionPortal visionPortal;
    public ColorBlobLocatorProcessor purpleLocator;
    public ColorBlobLocatorProcessor greenLocator;
...
//    private boolean purpleDetected = false;
     ...
     */
    public CameraVisionOuttakeDetection(HardwareMap hardwareMap, FtcDashboard db) {
        dashboard = db;
...
//    public String getPurpleDetected() {
//        return "Purple";
//    }
//
//    public String getGreenDetected() {
//        return "Green";
//    }

    public List<ColorBlobLocatorProcessor.Blob> getPurpleBlobs() {
        purpleBlobs = purpleLocator.getBlobs();
        return purpleBlobs;
    }

    public List<ColorBlobLocatorProcessor.Blob> getGreenBlobs() {
        greenBlobs = greenLocator.getBlobs();
        return greenBlobs;
    }
...
//    }
    ...
    public void configureCameraControls() {
        ...
        exposureControl.setExposure((long) 49, TimeUnit.MILLISECONDS);
    ...
    public Circle getClosestCircle(List<ColorBlobLocatorProcessor.Blob> blobList) {
        int frameWidth = 640;
        int frameHeight = 360;
